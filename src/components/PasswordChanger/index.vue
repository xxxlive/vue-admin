<template>
  <div class="vue-image-crop-upload">
    <div class="vicp-wrap">
      ...
      <div>
        <h1>更改密码</h1>
        <el-form ref="resetPasswordForm" :model="resetPasswordForm" :rules="resetPasswordRules" label-position="left" style="width: 100%; position: center">
          ...
          <el-form-item>
            <el-button type="primary" style="width:100%;" @click="handleResetPassword">
              确认更改
            </el-button>
          </el-form-item>
        </el-form>
        ...
        .then(response => {
          ...
          this.$refs.resetPasswordForm.validate(valid => {
            if (valid) {
              ...
              this.off()
              console.log('error occurs when submitting!!')
              return false
            }
          })
        })
